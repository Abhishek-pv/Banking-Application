...
access_key = os.getenv('AWS_ACCESS_KEY_ID','AKIAJ6LWBRKZ3236O7SA')
secret_access_key = os.getenv('AWS_SECRET_ACCESS_KEY','+fNfQyudgMEbdbclqGn373niK+vzqfTdzDqt+fAy+fNfQyudgMEbdbclqGn373niK+vzqfTdzDqt+fAy')
